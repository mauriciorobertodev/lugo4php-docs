function Formation() {
    return (
        ...
        >
            <g>
                <path
                    d="M256.004,116.85c32.26,0,58.425-26.156,58.425-58.417C314.43,26.173,288.265,0,256.004,0
		c-32.269,0-58.425,26.173-58.425,58.433C197.58,90.694,223.735,116.85,256.004,116.85z"
                />
                <path
                    d="M305.478,125.809c-1.271-1.264-7.031-1.591-8.59-0.623c-11.913,7.335-25.894,11.626-40.884,11.626
		...
		c-6.416,38.472,34.689,52.37,74.818,52.37c40.128,0,81.225-13.898,74.817-52.37C328.213,157.512,315.282,135.614,305.478,125.809z"
                />
                <path
                    d="M77.004,403.338c32.268,0,58.425-26.156,58.425-58.425c0-32.268-26.156-58.425-58.425-58.425
		c-32.261,0-58.416,26.156-58.416,58.425C18.588,377.182,44.744,403.338,77.004,403.338z"
                />
                <path
                    d="M126.478,412.298c-1.272-1.271-7.031-1.6-8.59-0.632c-11.914,7.344-25.894,11.626-40.884,11.626
		...
		C-4.221,498.101,36.876,512,77.004,512c40.136,0,81.234-13.899,74.818-52.378C149.213,444.001,136.29,422.094,126.478,412.298z"
                />
                <path
                    d="M376.57,344.913c0,32.269,26.156,58.425,58.425,58.425c32.261,0,58.417-26.156,58.417-58.425
		c0-32.268-26.156-58.425-58.417-58.425C402.727,286.488,376.57,312.645,376.57,344.913z"
                />
                <path
                    d="M509.814,459.622c-2.609-15.622-15.54-37.528-25.352-47.325c-1.264-1.271-7.023-1.6-8.59-0.632
		...
		"
                />
                <path
                    d="M112.981,229.688L94.8,225.594c3.905-12.635,10.272-24.491,18.837-34.796
		...
		l-20.807-4.676l20.774,45.699L112.981,229.688z"
                />
                <path
                    d="M280.199,471.937c-7.458,1.715-15.113,2.6-22.792,2.6c-5.685,0-11.388-0.484-17.057-1.443
		...
		l29.192-40.834l-46.085-13.365L280.199,471.937z"
                />
                <path
                    d="M396.172,188.214c9.426,9.911,16.876,21.676,21.676,34.672c2.42,6.523,4.176,13.374,5.185,20.437
...
function Pacifier() {
    return (
        ...
        >
            <path
                d="M18.8,4.9c-1.6,1.2-2.5,2.9-2.5,4.7c0,1.9-0.9,3.6-2.3,5l-0.2,0.2c-0.9,0.9-0.9,2.4,0,3.3l0,0
	c0.9,0.9,2.4,0.9,3.3,0l0.2-0.2c1.4-1.4,3.3-2.1,5.3-2.3c1.3-0.1,2.6-0.7,3.7-1.7c2.6-2.6,2.3-7-1-9.1C23.4,3.4,20.8,3.5,18.8,4.9z"
            />
            <circle cx="7.3" cy="24.6" r="3.1" />
            <path d="M22.5,15.7c2.1,3.7,2.3,7.5,0.2,9.6c-2.8,2.8-8.7,1.5-13.2-2.9S3.7,12,6.6,9.2c2.1-2.1,6-1.9,9.6,0.2" />
        </svg>
    );
}
