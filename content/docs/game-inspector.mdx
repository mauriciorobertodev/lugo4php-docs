...
Retorna o número de turnos restantes que a bola ainda pode ficar na àrea do gol antes de ser
kickada.
...
Retorna uma ordem de movimentação em direção a um ponto X, lança um erro caso gere uma ordem
inválida.
...
Retorna uma ordem de movimentação em direção ao centro de uma região X, lança um erro caso gere uma
ordem inválida.
...
Retorna uma ordem de movimentação em direção ao centro de uma região X, ou null caso gere uma ordem
inválida.
...
Retorna uma ordem de chute em direção ao centro de uma região X, lança um erro caso gere uma ordem
inválida.
...
Retorna uma ordem de chute em direção ao centro de uma região X, ou null caso gere uma ordem
inválida.
...
Retorna uma ordem de movimentação em direção a um player X, lança um erro caso gere uma ordem
inválida.
...
Retorna uma ordem de movimentação com velocidade 0, que faz o jogador permanecer no local mas olhar
em direção a um ponto X, lança um erro caso gere uma ordem inválida.
...
Retorna uma ordem de movimentação com velocidade 0, que faz o jogador permanecer no local mas olhar
em direção a um ponto X, ou null caso gere uma ordem inválida.
...
Retorna uma ordem de movimentação com velocidade 0, que faz o jogador permanecer no local mas olhar
em uma direção X, lança um erro caso gere uma ordem inválida.
...
Retorna uma ordem de movimentação com velocidade 0, que faz o jogador permanecer no local mas olhar
em uma direção X, ou null caso gere uma ordem inválida.
...
Retorna uma ordem de movimentação com velocidade 0, e com a mesma direção atual do jogador, que faz
com que ele apenas permaneça no lugar.
